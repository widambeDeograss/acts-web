...
export function AddministrationModal() {
  ...
  const handleOpen = () => {
    if (open) {
      ...
      dispatch(showModal("administrationAdd"));
    }
  };
  ...
  return (
    <>
      ...
      >
        <DialogHeader>Add an Administarive position</DialogHeader>
        <DialogBody>
        <form onSubmit={handleConfirm} ref={formRef} >
          ...
          <div>
            ...
            <input
              type="file"
              id="last_name"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 mb-3 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder=""
              name="image"
              required
            />
